...
public class TituloTest {
    ...
    void deveRetornarFalseQuandoHojeNaoEhAntesDoVencimento() {
        Titulo t = criarTituloPadrao();
        t.setDataVencimento(LocalDate.now()); // hoje n�o � antes do vencimento
    ...
    void deveRetornarFalseQuandoHojeNaoEhDepoisDaAplicacao() {
        Titulo t = criarTituloPadrao();
        t.setDataAplicacao(LocalDate.now()); // hoje n�o � depois da aplica��o
    ...
    void deveRetornarFalseQuandoUltimoRendimentoEhHoje() {
        Titulo t = criarTituloPadrao();
        t.setDataUltimoRendimento(LocalDate.now()); // hoje n�o � depois do �ltimo rendimento
