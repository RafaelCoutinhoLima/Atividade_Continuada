...
public class TesteConsultasOrdenadas extends TesteGenerico {
    ...
    void testConsultarTodosCadastroNulo() throws Exception {
        // Simulando comportamento: for�ando cadastro.buscarTodos() retornar null
        // Isso depende de como DAOGenerico � implementado.
    ...
    @Test
    @DisplayName("comparar deve retornar 1 quando renda do primeiro á maior")
    ...
    @Test
    @DisplayName("comparar deve retornar -1 quando renda do primeiro á menor")
    ...
    @Test
    @DisplayName("comparar deve lançar exceção quando algum argumento não á InvestidorPessoa")
